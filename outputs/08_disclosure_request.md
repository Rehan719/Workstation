# Disclosure Request: Minhas v Lonza Biologics Plc (6045461/2025)
...
The Claimant requests **Standard Disclosure** of the following documents in accordance with Rule 31 of the Employment Tribunal Rules of Procedure 2013 and the Respondent's ongoing duty of disclosure:

### 📁 Category 1: Health Data (Special Category) - JUSTIFICATION: To establish the s.15/26/27 claims regarding data protection and shaming.
1.1  **The "Unprotected Excel File"** mentioned in the formal grievance (6 Oct 2025). Provide the file itself, including all metadata, to identify who created it and who accessed it between 1 September 2025 and 10 October 2025.
1.2  **All internal communications (Emails/Teams/Slack)** between RJ (Line Manager), SD (Shift Manager), and HR personnel referring to the Claimant’s "mental health," "incontinence," "medication," or "side effects" between 1 August 2025 and 21 January 2026.

### 📁 Category 2: Occupational Health (OH) Records - JUSTIFICATION: To establish the s.20/21 failure to make reasonable adjustments.
2.1  **The full, unredacted OH Report** from Dr. Tahir dated 14 November 2025.
2.2  **The "Referral Instructions"** sent to OH by the Respondent’s managers/HR for the appointments on 13 October 2025 and 13 November 2025.
2.3  **Any internal meeting minutes or emails** discussing the implementation of Dr. Tahir’s recommendations (WAP, stress risk assessment, workplace relocation).

### 📁 Category 3: Performance & Punctuality (Comparator Data) - JUSTIFICATION: To establish less favourable treatment or substantial disadvantage.

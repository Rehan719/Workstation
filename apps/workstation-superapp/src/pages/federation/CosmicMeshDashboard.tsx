  ...
  return (
    <div className="space-y-12 pb-24">
      <header className="flex flex-col @[480px]:flex-row @[480px]:justify-between @[480px]:items-end gap-6">
        <div>
          <h1 className="text-3xl @[480px]:text-4xl @[680px]:text-6xl font-black mb-1 text-white tracking-tighter uppercase italic break-words">Cosmic Command</h1>
        ...
        <div className="flex gap-4 flex-wrap shrink-0">
           <Button onClick={() => notImplemented('Missions')} variant="outline"><Rocket size={18} /> Missions</Button>
           <Button onClick={() => notImplemented('Spawn Off-World Node')} className="bg-aura text-sovereign shadow-xl shadow-aura/20">

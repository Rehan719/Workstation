...
const ar: Dict = {
  // W373 — the 30 keys that were still falling back to English (mostly navigation,
  // shown on every screen). Product nouns (VSB, Genesis, CoE) stay untranslated.
  'home.whatItIs': 'ما هذا',
  'nav.home-facet': 'الرئيسية',
  'nav.work-facet': 'العمل في مجال',
  'nav.build-facet': 'بناء مؤسسة',
  'nav.platform-facet': 'المنصة',
  'nav.gov-facet': 'الحوكمة والثقة',
  'nav.system-facet': 'النظام',
  'nav.ai-tools': 'أدوات الذكاء الاصطناعي',
  'nav.qep': 'منصة القرآن',
  'nav.genesis': 'رحلة التكوين',
  'nav.vsb': 'استوديو إنشاء VSB',
  'nav.vsb-cockpit': 'قمرة قيادة VSB',
  'nav.business-plan': 'خطة العمل',
  'nav.management': 'أنظمة الإدارة',
  'nav.economy': 'الاقتصاد',
  'nav.native-ai': 'الذكاء الاصطناعي الداخلي',
  'nav.ceo': 'المنظمة الحية',
  'nav.resource-fabric': 'نسيج الموارد',
  'nav.reactor-studio': 'استوديو المفاعل',
  'nav.bto': 'التصنيع حسب الطلب',
  'nav.digital-twins': 'التوائم الرقمية',
  'nav.transformation': 'التحول',
  'nav.sovereign-evolution': 'التطور السيادي',
  'nav.governance-hub': 'مركز الحوكمة',
  'nav.change-control': 'ضبط التغيير',
  'nav.operations': 'التميز التشغيلي',
  'nav.coe': 'مركز التميز',
  'nav.creator': 'استوديو المبدع',
...
const fr: Dict = {
  // W373 — the 30 keys that were still falling back to English (mostly navigation,
  // shown on every screen). Product nouns (VSB, Genesis, CoE) stay untranslated.
  'home.whatItIs': 'Qu\'est-ce que c\'est',
  'nav.home-facet': 'Accueil',
  'nav.work-facet': 'Travailler dans un domaine',
  'nav.build-facet': 'Créer une entreprise',
  'nav.platform-facet': 'La plateforme',
  'nav.gov-facet': 'Gouvernance et confiance',
  'nav.system-facet': 'Système',
  'nav.ai-tools': 'Outils IA',
  'nav.qep': 'Plateforme Coran',
  'nav.genesis': 'Parcours Genesis',
  'nav.vsb': 'Studio de création VSB',
  'nav.vsb-cockpit': 'Cockpit VSB',
  'nav.business-plan': 'Plan d\'affaires',
  'nav.management': 'Systèmes de gestion',
  'nav.economy': 'Économie',
  'nav.native-ai': 'IA interne',
  'nav.ceo': 'Organisation vivante',
  'nav.resource-fabric': 'Tissu de ressources',
  'nav.reactor-studio': 'Studio réacteur',
  'nav.bto': 'Fabrication à la demande',
  'nav.digital-twins': 'Jumeaux numériques',
  'nav.transformation': 'Transformation',
  'nav.sovereign-evolution': 'Évolution souveraine',
  'nav.governance-hub': 'Pôle de gouvernance',
  'nav.change-control': 'Contrôle des changements',
  'nav.operations': 'Excellence opérationnelle',
  'nav.coe': 'Centre d\'excellence',
...
const es: Dict = {
  // W373 — the 30 keys that were still falling back to English (mostly navigation,
  // shown on every screen). Product nouns (VSB, Genesis, CoE) stay untranslated.
  'home.whatItIs': 'Qué es esto',
  'nav.home-facet': 'Inicio',
  'nav.work-facet': 'Trabajar en un dominio',
  'nav.build-facet': 'Crear una empresa',
  'nav.platform-facet': 'La plataforma',
  'nav.gov-facet': 'Gobernanza y confianza',
  'nav.system-facet': 'Sistema',
  'nav.ai-tools': 'Herramientas de IA',
  'nav.qep': 'Plataforma del Corán',
  'nav.genesis': 'Recorrido Genesis',
  'nav.vsb': 'Estudio de creación VSB',
  'nav.vsb-cockpit': 'Cabina VSB',
  'nav.business-plan': 'Plan de negocio',
  'nav.management': 'Sistemas de gestión',
  'nav.economy': 'Economía',
  'nav.native-ai': 'IA interna',
  'nav.ceo': 'Organización viva',
  'nav.resource-fabric': 'Tejido de recursos',
  'nav.reactor-studio': 'Estudio de reactor',
  'nav.bto': 'Fabricación por pedido',
  'nav.digital-twins': 'Gemelos digitales',
  'nav.transformation': 'Transformación',
  'nav.sovereign-evolution': 'Evolución soberana',
  'nav.governance-hub': 'Centro de gobernanza',
  'nav.change-control': 'Control de cambios',
  'nav.operations': 'Excelencia operativa',
  'nav.coe': 'Centro de excelencia',
  'nav.creator': 'Estudio del creador',
...
const ur: Dict = {
  // W373 — the 30 keys that were still falling back to English (mostly navigation,
  // shown on every screen). Product nouns (VSB, Genesis, CoE) stay untranslated.
  'home.whatItIs': 'یہ کیا ہے',
  'nav.home-facet': 'ہوم',
  'nav.work-facet': 'شعبے میں کام',
  'nav.build-facet': 'ادارہ بنائیں',
  'nav.platform-facet': 'پلیٹ فارم',
  'nav.gov-facet': 'گورننس اور اعتماد',
  'nav.system-facet': 'نظام',
  'nav.ai-tools': 'اے آئی ٹولز',
  'nav.qep': 'قرآن پلیٹ فارم',
  'nav.genesis': 'جینیسس سفر',
  'nav.vsb': 'VSB اسپان اسٹوڈیو',
  'nav.vsb-cockpit': 'VSB کاک پٹ',
  'nav.business-plan': 'کاروباری منصوبہ',
  'nav.management': 'انتظامی نظام',
  'nav.economy': 'معیشت',
  'nav.native-ai': 'اِن ہاؤس اے آئی',
  'nav.ceo': 'زندہ تنظیم',
  'nav.resource-fabric': 'ریسورس فیبرک',
  'nav.reactor-studio': 'ری ایکٹر اسٹوڈیو',
  'nav.bto': 'بلڈ ٹو آرڈر',
  'nav.digital-twins': 'ڈیجیٹل ٹوئنز',
  'nav.transformation': 'تبدیلی',
  'nav.sovereign-evolution': 'خودمختار ارتقا',
  'nav.governance-hub': 'گورننس مرکز',
  'nav.change-control': 'تبدیلی کنٹرول',
  'nav.operations': 'آپریشنل ایکسیلنس',
  'nav.coe': 'مرکزِ اعلیٰ',
  'nav.creator': 'کری ایٹر اسٹوڈیو',
  'nav.contribute': 'شراکت',

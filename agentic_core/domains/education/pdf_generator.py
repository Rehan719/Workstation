...
class SATsPDFGenerator:
    """
    Bundles all generated SATs materials into a single PDF.
    """
    def __init__(self, base_dir: str = "outputs/education/sats_2026"):
        self.base_dir = base_dir
        self.output_path = os.path.join(base_dir, "deliverable/Norbury_School_SATs_Prep_Pack_2026.pdf")
    ...
    def generate(self):
        ...
        elements.append(Paragraph("SATs 2026: PREPARATION PACK", title_style))
        elements.append(Spacer(1, 20))
        elements.append(Paragraph("Personalized for Norbury School Pupil", self.styles['Heading2']))
        elements.append(Spacer(1, 10))
        elements.append(Paragraph("Harrow, London", self.styles['Normal']))
        elements.append(Spacer(1, 100))

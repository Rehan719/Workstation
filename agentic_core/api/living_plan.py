...
_PHASES: Dict[str, List[str]] = {
    ...
    "short": [
        ...
        "Absorb the v191 evolution fragment under the Sovereign Evolution Office (open — legacy namespace, kept for live callers)",
    ],
    "long": [
        ...
        "User isolation (the §17.5 invariant) on business routers (partial — open on business-plan, change-control, board, swarm, studio; delivery plan P2.6)",

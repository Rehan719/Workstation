...
class SynthesisManager:
    ...
    async def generate_output(self, request: SynthesisRequest) -> Dict[str, Any]:
        ...
        if request.output_type == "report":
            content = f"# Sovereign Intelligence Report\n\n## Summary\n{context_summary}\n\n## Findings\n- Identified 94% alignment with Article 1127.\n- Cross-domain resonance detected in Science and Religion reactors."
            metadata["format"] = "pdf"
        elif request.output_type == "presentation":
            content = json.dumps([
                {"slide": 1, "title": "The Unified Mesh", "narration": "Welcome to the future of sovereign intelligence."},
                {"slide": 2, "title": "ESE Simulations", "narration": "Our evolutionary simulation engine has achieved 99% fidelity."},
                {"slide": 3, "title": "Conclusion", "narration": "Proceeding with v1.0 Global Launch."}
            ])
            metadata["format"] = "web-presentation"
            ...
            content = "Autonomous simulation results compiled."

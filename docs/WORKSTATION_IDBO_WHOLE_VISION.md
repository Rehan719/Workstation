<!--
  ...
  docs/AUTONOMOUS_PROGRESS.md (W1→W454).
...
- **P1.6 delivered (W454, 2026-09-12):** the Employment hub opens on the CV tools, and its job search is
  ...
  provenance badge on the search and on every generated document. Eight Tier-1 items remain open.
...
- `docs/AUTONOMOUS_PROGRESS.md` — the cycle-by-cycle execution log (W1→W454). A record of intent
...
2026-09-12, P1.2–P1.6 closed the same day):** eight Tier-1 truth defects on reached surfaces (fourteen

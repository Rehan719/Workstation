<!--
  ...
  docs/AUTONOMOUS_PROGRESS.md (W1→W453).
...
- **P1.5 delivered (W453, 2026-09-12):** every provenance badge routes through one helper (strings) or
  ...
  a source-grep guard fails on the old shape. Nine Tier-1 items remain open.
...
- `docs/AUTONOMOUS_PROGRESS.md` — the cycle-by-cycle execution log (W1→W453). A record of intent
...
2026-09-12, P1.2–P1.5 closed the same day):** nine Tier-1 truth defects on reached surfaces (fourteen
...
W452; the badges that painted the floor green closed W453; delivery-plan P1 —

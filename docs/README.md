...
- **[THE WHOLE VISION (fine resolution)](WORKSTATION_IDBO_WHOLE_VISION.md)** — the **canonical, fine-resolution** statement of the complete vision, faithful to the Owner's own words (incl. the native-AI-resources mandate: own swarm/models/orchestration, not external API calls). **This prevails over any narrower sampled summary — read this first.**
- **[Shared Understanding](WORKSTATION_IDBO_UNDERSTANDING.md)** — the "same page" doc: Owner profile, vision (envisaged + latest final), evidence base, my articulated understanding, open questions, fidelity commitments.
...
- **[Fable Delivery Prompt — ledger + delivery plan](FABLE_DELIVERY_PROMPT.md)** — v11 rev 2 (2026-09-05): what remains open against the vision, tiered by how much a real person is misled or blocked, and the ordered, verifiable plan (P1–P4) to deliver the whole of §1–§15 to completion.
- **[Vision Fidelity Ledger](VISION_FIDELITY_LEDGER.md)** — v3 (2026-09-05): the section-by-section verdict, 60 findings against a HEAD-booted backend, every one adversarially refuted; re-issued at every delivery-plan milestone (`scripts/workflows/fidelity_audit_v3.js`).
- **[Quran Education Platform — Whole Vision](QURAN_EDUCATION_PLATFORM_VISION.md)** — the Religion domain's flagship in full: concept, 8 strategic objectives, the 15 core features, the intelligence layer (Neural Core · the 99-aspect Fitrah Spectrum · swarm), the 19-phase roadmap, Waqf/Trust governance — reconstructed 2026-09-06 from three abandoned 2025 build attempts, with the audit of what each actually built. **Canon-resident summary: WHOLE_VISION Appendix A** — concept, vision, objectives and features only, provenance-graded; read A.9 (the six places §11 overrides the inherited vision) and A.10 (what is excluded as 2025-dated or agent-unreliable — including this document's own technology and roadmap parts).

...
**Status:** LIVING · **Last reconciled:** 2026-08-30 (W354) · **Grounded baseline:** in-house-first native AI fabric (owned models/orchestration/swarm/ensemble + autonomous workflow tree), integration suite ≈295✓ (15 skip) at the last CI-green run and growing, frontend tsc 0 errors, both CI green on `main`

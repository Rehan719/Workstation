...
## Overview
The Workstation Token (WST) is the primary economic unit of the Jules AI ecosystem. In v137.1, it is implemented as a cryptographically signed database ledger to ensure zero-cost infrastructure compliance while providing absolute non-repudiation.

## Current Infrastructure (v137.1)
...
3. **Bridge/Claim**: Users use their v137.1 public keys to claim native tokens on the destination chain.

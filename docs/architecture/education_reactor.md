...
## 2. Core Features (Parity)
*   **Curriculum Incubator:** Evolutionary design of learning paths.
*   **Lesson Plan Studio:** Synthesis of interactive pedagogy.
*   **Assessment Lab:** NLP-based question generation and rubric design.
*   **Mastery Analytics:** Cumulative dashboards showing student proficiency heatmaps.

...
HOW A ROUND IS SHAPED, AND HOW LONG IT COSTS (W487 — measured, so it is not re-argued each time):
  ...
  B1 TAKE A BATCH, NOT A ROW. The register's rows are one per emitting FILE; the sweep's ten classes
     run ACROSS files. A round that picked the next row closed two or three (W481, W485); the round
     that built ONE rule and swept every file consuming it closed seven (W483). Start each round from
     `python scripts/followups.py batches --item <the open item>` and take the largest CLOSABLE batch
     — rows citing only that class. Rows citing several classes are ADVANCED, never counted as closed.
     Measured: per-row projection 32 rounds for the open backlog; class batches ≈ 23.
...
every register change (add · close · drop · reslot · route · done · render); never edit between the markers.
  Next: P1.18 The third truth pass — 44 follow-ups ride it.
  Then, in order (the follow-ups riding each): P2.1 0 · P2.2 0 · P2.3 2 · P2.4 49 · P2.5 0 · P2.6 15 · P2.7 3 ·
    P2.8 12 · P2.9 35 · P3.0 0 · P3.1 0 · P3.2 0 · P3.3 0 · P3.4 0 · P3.5 0 · P3.6 0 · P3.7 0 · P3.8 0 ·
  ...
  Follow-up completion weighted by priority — P1: 54.4% of its rows' priority closed (58 of 102 rows); every phase's rows: 36.6% (the retired pre-plan queue left out).
  Follow-ups: 176 open — 176 ride a plan item (44 high), 0 unscheduled, 0 awaiting the Owner; 75 done, 4 dropped.
<!-- plannow:end -->
<!-- pace:begin (generated by scripts/followups.py render - never edit by hand) -->
WHERE THIS IS GOING (generated — 17 of 53 plan entries done, 176 open rows)
  PACE, over the last 6 round(s) that closed anything (W477, W479, W481, W483, W485, W488): 3.5 rows closed per round, 18.83 found, net -15.33.
  ONE-TIME INTAKE excluded from the rate: W477 (an audit, sweep or interrogation registers findings; it does not burn them). Steady rate over 5 round(s): 4.0 closed, 2.6 found, net 1.4.
  RATE USED: 4.0 rows/round — steady (one-time intakes excluded).
  NEXT — P1.18: 44 open rows ≈ 11 round(s) at the observed rate.
  ALL OPEN ROWS: 176 ≈ 44 round(s) at the same rate.
  BY ITEM: P1.18 44r≈11 · P2.3 2r≈1 · P2.4 49r≈13 · P2.6 15r≈4 · P2.7 3r≈1 · P2.8 12r≈3 · P2.9 35r≈9 · P3.12 4r≈1
  BIGGEST BATCH: C3 (invented or constant readings) — one mechanism closes 12 row(s) across 49 file(s), advancing 6 more. Items: P1.18, P2.4, P2.8, P2.9.
...
Open 176 (176 scheduled, 44 high · 0 unscheduled · 0 awaiting the Owner) · done 75 · dropped 4.

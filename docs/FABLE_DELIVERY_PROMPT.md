...
every register change (add · close · drop · reslot · route · done · render); never edit between the markers.
  Next: P1.18 The third truth pass — 50 follow-ups ride it.
  Then, in order (the follow-ups riding each): P2.1 0 · P2.2 0 · P2.3 1 · P2.4 46 · P2.5 0 · P2.6 15 · P2.7 3 ·
  ...
  Follow-up completion weighted by priority — P1: 49.3% of its rows' priority closed (52 of 102 rows); every phase's rows: 33.4% (the retired pre-plan queue left out).
  Follow-ups: 177 open — 177 ride a plan item (50 high), 0 unscheduled, 0 awaiting the Owner; 69 done, 3 dropped.
<!-- plannow:end -->
<!-- pace:begin (generated by scripts/followups.py render - never edit by hand) -->
WHERE THIS IS GOING (generated — 17 of 53 plan entries done, 177 open rows)
  PACE, over the last 6 round(s) that closed anything (W475, W477, W479, W481, W483, W485): 4.83 rows closed per round, 17.83 found, net -13.0.
  ONE-TIME INTAKE excluded from the rate: W477 (an audit, sweep or interrogation registers findings; it does not burn them). Steady rate over 5 round(s): 5.6 closed, 1.4 found, net 4.2.
  RATE USED: 5.6 rows/round — steady (one-time intakes excluded).
  NEXT — P1.18: 50 open rows ≈ 9 round(s) at the observed rate.
  ALL OPEN ROWS: 177 ≈ 32 round(s) at the same rate.
  BY ITEM: P1.18 50r≈9 · P2.3 1r≈1 · P2.4 46r≈9 · P2.6 15r≈3 · P2.7 3r≈1 · P2.8 12r≈3 · P2.9 34r≈7 · P3.12 4r≈1
  BIGGEST BATCH: C5 (a second writer or the reached page disagrees with the API) — one mechanism closes 16 row(s) across 50 file(s), advancing 9 more. Items: P1.18, P2.4, P2.6, P2.7, P2.8, P2.9.
...
Open 177 (177 scheduled, 50 high · 0 unscheduled · 0 awaiting the Owner) · done 69 · dropped 3.

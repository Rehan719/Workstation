...
every register change (add · close · drop · reslot · route · done · render); never edit between the markers.
  Next: P1.18 The third truth pass — 37 follow-ups ride it.
  Then, in order (the follow-ups riding each): P2.1 0 · P2.2 0 · P2.3 1 · P2.4 37 · P2.5 0 · P2.6 12 · P2.7 1 ·
    P2.8 7 · P2.9 27 · P3.0 0 · P3.1 0 · P3.2 0 · P3.3 0 · P3.4 0 · P3.5 0 · P3.6 0 · P3.7 0 · P3.8 0 ·
  ...
  Follow-up completion weighted by priority — P1: 61.3% of its rows' priority closed (66 of 103 rows); every phase's rows: 52.7% (the retired pre-plan queue left out).
  Follow-ups: 139 open — 139 ride a plan item (37 high), 0 unscheduled, 0 awaiting the Owner; 119 done, 4 dropped.
<!-- plannow:end -->
<!-- pace:begin (generated by scripts/followups.py render - never edit by hand) -->
WHERE THIS IS GOING (generated — 17 of 53 plan entries done, 139 open rows)
  PACE, over the last 6 round(s) that closed anything (W485, W488, W489, W490, W491, W492): 8.83 rows closed per round, 2.33 found, net 6.5.
  RATE USED: 8.83 rows/round — steady (one-time intakes excluded).
  NEXT — P1.18: 37 open rows ≈ 5 round(s) at the observed rate.
  ALL OPEN ROWS: 139 ≈ 16 round(s) at the same rate.
  BY ITEM: P1.18 37r≈5 · P2.3 1r≈1 · P2.4 37r≈5 · P2.6 12r≈2 · P2.7 1r≈1 · P2.8 7r≈1 · P2.9 27r≈4 · P3.12 5r≈1
  BIGGEST BATCH: C4 (present-tense claims about processes not running) — one mechanism closes 9 row(s) across 38 file(s), advancing 8 more. Items: P1.18, P2.4, P2.9.
...
Open 139 (139 scheduled, 37 high · 0 unscheduled · 0 awaiting the Owner) · done 119 · dropped 4.

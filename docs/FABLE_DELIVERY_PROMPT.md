...
every register change (add · close · drop · reslot · route · done · render); never edit between the markers.
  ...
  Follow-up completion weighted by priority — P1: 28.8% of its rows' priority closed (42 of 102 rows); every phase's rows: 19.9% (the retired pre-plan queue left out).
  Follow-ups: 171 open — 171 ride a plan item (60 high), 0 unscheduled, 0 awaiting the Owner; 59 done, 2 dropped.
<!-- plannow:end -->
...
Open 171 (171 scheduled, 60 high · 0 unscheduled · 0 awaiting the Owner) · done 59 · dropped 2.

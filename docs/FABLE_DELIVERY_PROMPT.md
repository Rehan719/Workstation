...
every register change (add · close · drop · reslot · route · done · render); never edit between the markers.
  ...
  Then, in order (the follow-ups riding each): P2.1 0 · P2.2 0 · P2.3 1 · P2.4 39 · P2.5 0 · P2.6 13 · P2.7 3 ·
    P2.8 8 · P2.9 30 · P3.0 0 · P3.1 0 · P3.2 0 · P3.3 0 · P3.4 0 · P3.5 0 · P3.6 0 · P3.7 0 · P3.8 0 ·
  ...
  Follow-up completion weighted by priority — P1: 61.3% of its rows' priority closed (66 of 103 rows); every phase's rows: 49.9% (the retired pre-plan queue left out).
  Follow-ups: 148 open — 148 ride a plan item (37 high), 0 unscheduled, 0 awaiting the Owner; 109 done, 4 dropped.
<!-- plannow:end -->
<!-- pace:begin (generated by scripts/followups.py render - never edit by hand) -->
WHERE THIS IS GOING (generated — 17 of 53 plan entries done, 148 open rows)
  PACE, over the last 6 round(s) that closed anything (W483, W485, W488, W489, W490, W491): 8.33 rows closed per round, 2.83 found, net 5.5.
  RATE USED: 8.33 rows/round — steady (one-time intakes excluded).
  NEXT — P1.18: 37 open rows ≈ 5 round(s) at the observed rate.
  ALL OPEN ROWS: 148 ≈ 18 round(s) at the same rate.
  BY ITEM: P1.18 37r≈5 · P2.3 1r≈1 · P2.4 39r≈5 · P2.6 13r≈2 · P2.7 3r≈1 · P2.8 8r≈1 · P2.9 30r≈4 · P3.12 5r≈1
  BIGGEST BATCH: C5 (a second writer or the reached page disagrees with the API) — one mechanism closes 10 row(s) across 44 file(s), advancing 9 more. Items: P1.18, P2.4, P2.6, P2.7, P2.8, P2.9.
...
Open 148 (148 scheduled, 37 high · 0 unscheduled · 0 awaiting the Owner) · done 109 · dropped 4.

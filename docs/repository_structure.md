# Jules AI Repository Structure

## Root Directory
- `agentic_core/`: Core autonomous logic, engines, and constitutional framework.
- `src/`: Source code for applications and user interfaces.
- `docs/`: Comprehensive platform documentation.
- `infra/`: Infrastructure as code and deployment configurations.
- `scripts/`: Operational utility scripts.
- `tests/`: System verification and quality assurance.
...
- `docs/resources/`: Strategic research on cloud and advanced compute integration.

## Core Mandates
Governed by the **Canonical Constitution** located in `agentic_core/constitution/CONSTITUTION_canonical.md`.

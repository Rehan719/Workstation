...
| :--- | :--- | :--- | :--- |
| **Day 1** | Send Exhibit Q-1 Demand | Template 1 | Punter Southall Law |
| **Day 2** | Send Formal Disclosure | Template 2 | Punter Southall Law |
| **Day 3** | Call ACAS | Template 3 | ACAS Conciliator |
...
### Template 2: ACAS Opening Statement (Script)
...
Under the new **Thompson v TechFlow** precedent, tribunals must scrutinize whether disability factors were excluded from performance assessments. Lonza's records show they were **NOT** excluded.

I am looking to settle this efficiently. My opening position is **£78,000**."

---

## ✅ **Complete Action Checklist**
- [ ] Day 1: Send Templates.
- [ ] Week 4: Finalize Witness Statement (`12_draft_witness_statement.md`).
- [ ] Hearing Day: Arrive 45 mins early with `02_chronology.md`.

...
class {sub_domain_cap}Reactor(SpecializedReactor):
    """
...
def generate_reactor(domain: str, sub_domain: str) -> Path:
    """Render the SpecializedReactor template for a domain/sub_domain and write it to disk."""
    content = TEMPLATE.format(
        domain=domain,
        sub_domain=sub_domain,
        sub_domain_cap=sub_domain.capitalize(),
    )

...
## 🚨 **IMMEDIATE ACTIONS — FIRST 7 DAYS (Execute in Order)**

### **Action 1: Secure Exhibit Q-1 Raw Data (Send TODAY)**
**When**: Immediately — before any other correspondence
**To**: Punter Southall Law (Respondent's Solicitors) + Lonza HR Department
**CC**: Employment Tribunal Office + Your Personal Email
...
**To**: Punter Southall Law
**CC**: Employment Tribunal Office
...
To properly prepare my case regarding discrimination arising from disability and victimisation, I require the following documents/information by [Insert Date: 14 days from sending]:

CATEGORY 1: COMPARATOR DATA
• Attendance and disciplinary records for all employees in the same department/role as the Claimant over the last 24 months.
...
... [Full details from guide]
```

### **Action 3: Engage ACAS Conciliation (Within 72 Hours)**
**Call**: 0300 123 1100
**Script**: "This is a clear case of discrimination arising from disability. Lonza's own records show I was 94% punctual..."

---

## 🗺️ **HOW TO USE YOUR DOCUMENT ARSENAL**
- Phase A: Strategy & Foundation (01_executive_summary, 04_strengths)
- Phase B: Evidence & Disclosure (06_evidence_map, 08_disclosure_request)
- Phase C: Settlement & Negotiation (09_acas_settlement, 11_schedule_of_loss)
- Phase D: Witness Prep & Hearing (12_witness_statement, 17_cross_exam)

---

## ✅ **COMPLETE ACTION CHECKLIST**
- [ ] Day 1: Send Template 1 (Exhibit Q-1)
- [ ] Day 2: Send Template 2 (Formal Disclosure)
- [ ] Day 3: Call ACAS
- [ ] Week 4: Finalize Witness Statement

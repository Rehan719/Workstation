...
from agentic_core.triad.neuro_symbolic.reasoner import NeuroSymbolicReasoner
from agentic_core.triad.neuro_symbolic.causal_reasoner import CausalReasoner
from agentic_core.triad.neuro_symbolic.proof_agent import FormalProofAgent
from agentic_core.triad.quantum.optimizer import QuantumOptimizer
from agentic_core.triad.xai.explainer import AdaptiveXAI
from agentic_core.verification.pipeline import VerificationPipeline
from agentic_core.ueg.ledger import UnifiedEvidenceGraph
from agentic_core.self_improvement.self_improvement import SelfImprovementEngine
...
from agentic_core.scholarship.dora_retriever import DORARetriever
from agentic_core.scholarship.review_generator import ScientificReviewGenerator
from agentic_core.research.workflow_composer import WorkflowComposer
from agentic_core.research.assistant import ResearchAssistant
from agentic_core.evidence.multimodal_fusion import MultimodalFusionEngine

# Article U/AZ integrations
from agentic_core.orchestrator.backend_mapper import UniversalTranslator, MultiCloudBroker, BackendMapper

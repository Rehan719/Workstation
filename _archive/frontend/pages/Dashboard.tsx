        ...
        <div className="@[440px]:col-span-2 space-y-8">
           <Card className="h-[400px] flex flex-col justify-center items-center relative overflow-hidden bg-slate-950/20">
              ...
              <div className="absolute bottom-8 right-8 z-10 flex gap-4">
                 <button type="button" onClick={() => navigate('/organism')} className="px-6 py-3 bg-aura/10 border border-aura/30 text-aura rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-aura hover:text-sovereign transition-all">Mesh Explorer</button>
              </div>
           </Card>

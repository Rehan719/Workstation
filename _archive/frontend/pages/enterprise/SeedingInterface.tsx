    ...
    <div className="space-y-12 pb-24">
      <header className="flex flex-col @[480px]:flex-row @[480px]:justify-between @[480px]:items-end gap-6">
        ...
        <div className="flex gap-4 flex-wrap shrink-0">
           <Button onClick={() => notImplemented('Seed Records')} variant="outline"><History size={18} /> Seed Records</Button>
           <Button onClick={() => notImplemented('Define New Seed')} className="bg-aura text-sovereign shadow-xl shadow-aura/20">

        ...
        <div className="portal-content grid grid-cols-1 @[440px]:grid-cols-3 gap-12">
          ...
          <aside className="space-y-8">
            ...
            <div className="p-6 bg-emerald-900/10 rounded-xl border border-emerald-500/20 shadow-xl">
              ...
              <button type="button" onClick={async () => { try { const r = await fetch('/api/v1/qep/adaptation/registry'); const d = await r.json(); toast(`${d.count} cross-domain adaptations registered`); } catch { toast('Failed to load registry'); } }} className="w-full py-2 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 rounded text-xs transition-all">
